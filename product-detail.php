...
<div class="">
  <h2 class="text-center mt-5"style="font-family: monospace;">Chi tiết sản phẩm</h2>
</div>
...
<main>
  ...
  <div class="container">
    ...
    <section class="my-5">
      <div class="row">
        ...
        <div class="col-md-7">
          ...
          <p><span class="mr-1"><strong>Giá: <?php echo number_format($price); ?></strong></span></p>
          ...
          <form method="post">
            ...
            if (isset($_SESSION['email'])) {
                ...
                if (mysqli_num_rows($run_cart) > 0) {
                  while ($row = mysqli_fetch_array($run_cart)) {
                    ...
                    if ($p_id == $exist_pro_id) {
                      echo "<script>alert('⚠️ Sản phẩm đã có trong giỏ hàng '); </script>";
                    }
                  }
                }
              }
              ...
              echo "<script> function a(){
                        alert('⚠️ Bạn cần đăng nhập trước khi thêm vào giỏ hàng');
                          }</script>";
            }
    ...
    <section>
      ...
      <h3 class="text-center pt-5 mb-0"style="font-family: monospace;">Sản phẩm liên quan </h3>
            ...
            <div class="col-md-6 col-lg-3 mb-4">
              ...
              <div class="row">
                <div class="col-md-12 col-sm-12 col-12 text-center">
                  ...
                  <a href="product-detail.php?product_id=<?php echo $pid; ?>" type="submit" onclick="a()" class="btn btn-primary btn-sm hover-effect"style="background-color: #7ac8d4;">
