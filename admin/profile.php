           ...
           <div class="col-md-3 col-lg-3">
            ...
            <div class="col-md-9 col-lg-9">
               ...
               <div class="row">
                  ...
                  <h1 class="ml-5 display-4 font-weight-normal">Cài đặt tài khoản admin:</h1>
                  </div>
                </div>
              <hr>
                 ...
                 <div class="row">
                  ...
                  <div class="row mt-4">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label for="name" class="font-weight-bold">Mật khẩu:</label>
                        <input type="password" name="password" value="<?php echo $db_password;?>" class="form-control" id="inputPassword4MD" placeholder="Mật khẩu">
                      </div>
                  ...
                  <input type="submit" name="submit" class="btn btn-primary btn-md" value="Cập nhật">
                </form>
            </div>
    </div>
                <!-- Extended material form grid -->
