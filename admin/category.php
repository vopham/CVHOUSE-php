    ...
    <div class="col-md-9 col-lg-9">
      ...
      <div class="col-md-9">
          ...
          <div class="row">
            ...
            <div class="col-lg-8">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <input type="text" name="fonts" class="form-control" placeholder="Thêm icon tìm ở trang fontawesome.com(ví dụ: fa-lightbulb-o">
                </div>
              </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="col-md-6"><td>
                  ...
                  echo "Tổng số loại sản phẩm: " ;echo $data['total']; echo " Loại" ?>
                </td></div>
        <?php
        $r_data = 6;
              ...
              <table class="table table-hover">
                <thead class="thead-dark">
                  <tr>
                    ...
                    <th>ID</th>
                    <th>Biểu tượng loại hsản phẩm</th>
