...
?>
    <div class="">
        <h1 class="text-center text-dark mt-5"style="font-family:monospace;">Đơn hàng của tôi</h1>
    </div>
      ...
      <div class="row">
         ...
         <div class="col-md-9">
          ...
          ?>      
                             ...
                             <tr>
                                <td>#<?php echo $order_invoice;?></td>
                                 ...
                                 <td><?php 
                                  ...
                                  else if($order_status == 'Đã giao hàng'){
              ...
              echo "<h2 class='text-center text-secondary mt-5 mb-5'>Bạn chưa đặt hàng </h2>";
              }
              ?>
