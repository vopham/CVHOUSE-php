        ...
        if(mysqli_num_rows($run) > 0){
          ...
          if(mysqli_num_rows($pr_run) > 0){
            while($pr_row = mysqli_fetch_array($pr_run)){
              ...
              $single_pro_total_price,'$invoice',$db_pro_qty,'$date','Chờ xác nhận')";
                  ...
                  if(mysqli_query($con,$checkout_query)){
                        ...
                        if(mysqli_query($con,$del_query)){
                         $_SESSION['message'] ="<div class='alert alert-primary alert-dismissible fade show pt-1 pb-1 pl-3' role='alert'>
                          <strong><i class='fas fa-check-circle'></i> Cám ơn! </strong> cho đơn đặt hàng của bạn,đơn hàng sẽ được giao tối đa 7 ngày
            ...
            ?>
                  ...
                  <div class="row">
                   ...
                   <form method="post"  class="mt-4">
                      <div class="form-group">
                        ...
                        <input type="text" name="fullname" placeholder="Họ tên" class="form-control" value="<?php echo $customer_name; ?>" required>
                      </div>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-6">
                          ...
                          <label for="postalcode">Mã bưu điện:</label>
                            <input type="number" name="code" placeholder="Mã bưu điện" class="form-control" value="<?php echo $customer_pcode; ?>" required >
                        </div>
                        </div>
               ...
               <div class="col-md-6 p-3">
                 ...
                 <h5>Thông tin sản phẩm đơn hàng</h5><hr>
